...
ALTER TABLE HOP_DOthiet_biNG ADD CONSTRAINT FK_HOPDONG_KHACHTHUE FOREIGN KEY (MaKhachThue)
REFERENCES KHACH_THUE(MaKhachThue)
...
ALTER TABLE CHI_TIET_DV ADD CONSTRAINT FK_CHI_TIET_DV_HOA_DON FOREIGN KEY (MaHoaDon)
